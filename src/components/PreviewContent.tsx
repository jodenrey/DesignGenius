          ...
          {isGenerating && (
            <div className="text-white text-center px-4">
              ...
              <p className="text-sm opacity-80 animate-fade-in-delay">
                This may take up to 45 seconds. On the 1st-2nd try it might failed because the AI model is still cold and vercel only handle up to 1min. Just generate it again and after that it is fine. Thank you for your patience!
              </p>
            </div>
          )}
          {isGenerating && (
